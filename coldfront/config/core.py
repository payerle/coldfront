...
# (ignored unless PLUGIN_LDAP_AUTH is also True)
ORGANIZATION_LDAP_AUTH_POPULATE_USER_ORGANIZATIONS = ENV.str(
    'ORGANIZATION_LDAP_AUTH_POPULATE_USER_ORGANIZATIONS', True)

# Attribute of ldap_user used for populating Organizations for user
# (the attribute should return strings matching directory_string in
# Directory2Organization table)
ORGANIZATION_LDAP_USER_ATTRIBUTE = ENV.str(
    'ORGANIZATION_LDAP_USER_ATTRIBUTE', 'umDepartment')
# Whether to add parent organizations to user when populating 
# Organizations from LDAP.  Boolean.
...
# user's organization list from LDAP
